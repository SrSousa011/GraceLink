    ...
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, double>>(
        ...
        builder: (context, revenueSnapshot) {
          ...
          final totalExpenses = revenueData['totalOverallIncome'] ?? 1000.0;
          final totalBalance = totalReceita - totalExpenses;
          ...
          return FutureBuilder<DonationStats>(
            ...
            builder: (context, donationSnapshot) {
              ...
              if (!donationSnapshot.hasData) {
                return const Center(child: Text('Donation stats not found.'));
              }
